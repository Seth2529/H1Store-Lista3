    ...
    public class ApplicationToDomain : Profile
    {
        public ApplicationToDomain()
        {
            ...
            CreateMap<FornecedorViewModel, Fornecedor>()
               .ConstructUsing(q => new Fornecedor(q.Codigo, q.RazaoSocial, q.CNPJ, q.Ativo, q.DataCadastro, q.EmailContato));
            CreateMap<NovoFornecedorViewModel, Fornecedor>()
               .ConstructUsing(q => new Fornecedor(0, q.RazaoSocial, q.CNPJ, q.Ativo, q.DataCadastro, q.EmailContato));
        }
    }
}
